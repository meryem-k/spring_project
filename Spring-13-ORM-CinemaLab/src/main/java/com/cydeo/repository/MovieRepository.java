...
public interface MovieRepository extends JpaRepository<Movie, Long> {
    ...
    List<Movie> findAllByPriceBetween(BigDecimal price1, BigDecimal rice2);
    ...
    @Query(value = "SELECT * FROM Movie ORDER BY DESC LIMIT 5", nativeQuery = true)
    List<Movie> top5MostExpensiveMovies();
