...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    Integer countTicketInDateRange(@Param("dateTime1") LocalDateTime dateTime1, @Param("dateTime2") LocalDateTime dateTime2);
    ...
    Optional<Ticket> retrieveAllDistinctMovieNames();
    ...
    List<Ticket> findAllTicketsByUserNameAndNameAndMovieNameContaining(@Param("pattern") String pattern);
